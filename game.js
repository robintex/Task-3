...
async function playDiceGame(dice1, dice2) {
  ...
  // Generate random number using crypto.randomInt
  const computerThrow1 = crypto.randomInt(0, 6); // Random number between 0 and 5
  ...
  const computerThrow2 = crypto.randomInt(0, 6); // Random number between 0 and 5
...
async function main() {
  // Read dice configurations from command-line arguments
  ...
  const firstMove = crypto.randomInt(0, 2); // Random number between 0 and 1
